...
class SubscriptionEmailService:
    ...
    def _build_subscribed_email(self, user: User) -> EmailContent:
        ...
        return EmailContent(
            subject="Thanks for subscribing to AutoClipper AI",
            html=(
                f"<p>Hi {first_name},</p>"
                "<p>Thanks for subscribing to AutoClipper AI.</p>"
                "<p>Your paid plan is now active, and you can jump back in anytime to create more clips.</p>"
                "<p>We’re excited to have you with us.</p>"
                "<p>Team AutoClipper AI</p>"
            ),
            text=(
                f"Hi {first_name},\n\n"
                "Thanks for subscribing to AutoClipper AI.\n\n"
    ...
    def _build_unsubscribed_email(self, user: User) -> EmailContent:
        first_name = self._first_name_for(user)
        return EmailContent(
            subject="Sorry to see you go from AutoClipper AI",
            html=(
                f"<p>Hi {first_name},</p>"
                "<p>Sorry to see you go, and thanks for trying AutoClipper AI.</p>"
                "<p>Your subscription has been canceled. If you ever want to come back, we’d love to have you.</p>"
                "<p>Team AutoClipper AI</p>"
            ),
            text=(
                f"Hi {first_name},\n\n"
                "Sorry to see you go, and thanks for trying AutoClipper AI.\n\n"
